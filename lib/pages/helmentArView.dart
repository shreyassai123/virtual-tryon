...
void main() async {
  ...
  runApp(const HelmetARViewPage());
}

class HelmetARViewPage extends StatefulWidget {
  const HelmetARViewPage({Key? key}) : super(key: key);

  @override
  State<HelmetARViewPage> createState() => _HelmetARViewPageState();
}

class _HelmetARViewPageState extends State<HelmetARViewPage> {
  @override
  void initState() {
    super.initState();
  }
          ...
          child: DeepArPreview(
            ...
            onViewCreated: () {
              _controller.switchEffect(
                  _assetEffectsPath + 'helmet.deepar');
            },
          ),
        ),
        _topMediaOptions(),
